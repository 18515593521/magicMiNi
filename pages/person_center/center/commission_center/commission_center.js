...
Page({
  ...
  getCommissionInfo: function () {
    ...
    data.shopId = app.globalData.shopInfo.sys_user_id
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (resturnData.code == 0) {
          ...
          if (is_horizontal_alliances && (resturnData.result.userCommissionSet.customer_commission_status == 1 && app.globalData.customerInfo.is_horizontal_alliances == 2) || (resturnData.result.userCommissionSet.horizontal_alliances_commission_status == 1 && app.globalData.customerInfo.is_horizontal_alliances == 1)){
